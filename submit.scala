...
Executable   =  /direct/phenix+u/vassalli/Condor.sh
...
# and output.
Initialdir   = /direct/phenix+u/vassalli

# Input file given to the job.
Input           = /dev/null

# The job’s stdout is sent to this file.
Output       =/direct/phenix+u/vassalli/out.$(Process)

# The job’s stderr is sent to this file.
Error        = /direct/phenix+u/vassalli/err.$(Process)

# The condor log file for this job, useful when debuggin
Log          = /direct/phenix+u/vassalli/log.$(Process)
