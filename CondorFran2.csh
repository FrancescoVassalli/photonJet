#!/bin/csh 
#This is the condor shell script for 20-30GeV photons, note pTHatMin should be 15GeV
...
./photonjetmaker XjPhi2_pT15_${1} 15 20 3000000
cp XjPhi2_pT15_${1}* $OUT_FILE
